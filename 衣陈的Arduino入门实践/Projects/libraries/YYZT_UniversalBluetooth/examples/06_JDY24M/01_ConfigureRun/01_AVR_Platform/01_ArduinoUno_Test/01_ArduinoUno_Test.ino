...
#define bluetoothName "JDY24M"                        // 蓝牙的名称（18字符内）
#define bluetoothPassword "123456"                    // 蓝牙的配对连接密码（6位数）
#define bluetoothType JDY24M_TypeBindingWithPassword  // 蓝牙蓝牙密码连接方式，这是配置为JDY24M有密码连接，并绑定
...
void setup() {
  ...
  jdy24m.setPassword(bluetoothPassword);  // 设置蓝牙的配对连接密码（6位数）
